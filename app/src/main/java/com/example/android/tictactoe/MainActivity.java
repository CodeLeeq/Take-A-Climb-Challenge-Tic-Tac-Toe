...
public class MainActivity extends AppCompatActivity {
    ...
    private void play(Button button) {
        ...
        if (button.getText().toString().equals("")) {
            ...
            RadioButton playX = (RadioButton) findViewById(R.id.playerX);
            RadioButton playO = (RadioButton) findViewById(R.id.playerO);
            if (playX.isChecked()) {
                player = "X";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * This method is called when any of the button is clicked and it set it to preffered text.
         */
    ...
    public void displayForPlayerX(int score) {
        TextView scoreView = (TextView) findViewById(R.id.playerX_score);
